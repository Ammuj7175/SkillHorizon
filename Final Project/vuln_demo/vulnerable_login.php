...
if ($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    $res=$conn->query($sql);
    if($res && $res->num_rows===1){ $message="Login successful! Welcome $username"; $message_type='success'; }
...
<p style="font-size:12px;margin-top:10px;">Try SQLi payload: <code>' OR '1'='1</code></p>
</div>
</body>
</html>
